// q1_181172.cpp : Defines the entry point for the console application.
//
...
int main()
{
	...
	*/
	...
	//cout << "Day" << d1[0]; //return day i.e 30
	//cout << "Month" << d1[1]; //return month i.e 12
	//cout << "Year" << d1[2]; //return year i.e 2019
